<div class="sitenav">
    <nav class="sitenav-items">
        ...
        <ul class="sitenav-items_ul">
            <li class="sitenav-items_li login_mobile"><i class="fa-solid fa-lock"></i><a href="./login.php"><?=isset($_SESSION['username']) ? 'Hi '. $_SESSION['username'] :'Login'?></a></li>
    ...
    <div class="usercontrol">
        <div class="login_desktop"><i class="fa-solid fa-lock"></i><a href="./login.php"><?=isset($_SESSION['username']) ? 'Hi '.$_SESSION['username'] :'Login'?></a></div>
        <div class="cart">
            <i class="fa-solid fa-cart-shopping"></i>
            <a href="./cart.php">View Cart</a>
        </div>
        <div class="cart-items">
            <a href="./cart.php"><span class="<?=isset($_SESSION["cartItem"]) && $_SESSION["cartItem"] > 0 ? "cart-item_count":""?>"><?= $_SESSION["cartItem"] ?? 0 ?></span> item<?=isset($_SESSION["cartItem"]) && $_SESSION["cartItem"] > 1 ? "s":""?></a>
        </div>
